    ...
    <section className="section-padding bg-white">
      <div className="container-custom">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-1/2 left-0 w-full h-0.5 bg-gray-200 -z-10 -translate-y-1/2" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              <motion.div
                ...
                className="bg-white p-6 rounded-xl border border-gray-100 shadow-lg relative group hover:-translate-y-2 transition-transform duration-300"
              >
                <div
                ...
                <div className="absolute top-6 right-6 font-bold text-6xl text-gray-50 opacity-10 select-none">
                  0{index + 1}
                </div>
                <h3 className="text-xl font-bold font-heading mb-3 text-center">
                  {step.title}
                </h3>
